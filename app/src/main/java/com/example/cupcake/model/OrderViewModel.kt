...
private const val PRICE_VANILLA = 2.00
private const val PRICE_CHOCOLATE = 3.00
private const val PRICE_RED_VELVET = 3.00
private const val PRICE_SALTED_CARAMEL = 3.80
private const val PRICE_COFFEE = 3.50
...
class OrderViewModel : ViewModel() {
    ...
    private var calculatedPrice: Double = 0.0
     ...
     */
    private fun updatePrice(data: Any)  {

        calculatedPrice = when(data){
            "Vanilla" -> (quantity.value ?: 0) * PRICE_VANILLA
            "Chocolate" -> (quantity.value ?: 0) * PRICE_CHOCOLATE
            "Red Velvet" -> (quantity.value ?: 0) * PRICE_RED_VELVET
            "Salted Caramel" -> (quantity.value ?: 0) * PRICE_SALTED_CARAMEL
            "Coffee" -> (quantity.value ?: 0) * PRICE_COFFEE
            else -> (quantity.value ?: 0) * PRICE_VANILLA
        }
